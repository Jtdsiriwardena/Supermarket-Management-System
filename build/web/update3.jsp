...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update products3 set productName = ?,productPrice = ?,Category = ? where id = ?");
    ...
    <body>
        <h1>Product Update</h1>
         ...
         <form method="POST" action="#">
          ...
          pst = con.prepareStatement("select * from products3 where id = ?");
          pst.setString(1, id);
          rs = pst.executeQuery();
          ...
          while(rs.next())
          {
           ...
           <div align="right">
               <p> <a href="adminPage3.jsp" class="btn btn-warning">Click Back</a></p>
           </div>
