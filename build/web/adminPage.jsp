...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into products(productName,quantity,productPrice,Category)values(?,?,?,?)");
        ...
        <table id="product-tbl" class="table table-responsive table bordered" cellpadding="0" width="100%">
            <thead>
                ...
                <tr>
                    ...
                    <td><a href="update.jsp?id=<%=id%>" class="btn btn-success" > Edit</a></td>
