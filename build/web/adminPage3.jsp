...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("insert into products3(productName,quantity,productPrice,Category)values(?,?,?,?)");
        ...
        <table id="product-tbl" class="table table-responsive table bordered" cellpadding="0" width="100%">
            <thead>
                ...
                <%
                 ...
                 String query = "select * from products3";
                ...
                <tr>
                    ...
                    <td><a href="update3.jsp?id=<%=id%>" class="btn btn-success" > Edit</a></td>
                    <td><a href="delete3.jsp?id=<%=id%>" class="btn btn-danger"> Delete</a></td>
